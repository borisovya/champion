      ...
      >
        ...
        >
          <img
            ...
            alt="Champion Partners Logo"
            style="height: 80px"
          />
          <span class="text-purple-500 font-bold text-5xl">404</span>
          <h1 class="text-900 font-bold text-3xl lg:text-5xl mb-2">Not Found</h1>
          <div class="text-600 mb-5">
            Такой страницы нет. но есть много других полезных страниц.
          </div>
          <router-link
            to="/"
          ...
          >
            <span
              class="flex justify-content-center align-items-center bg-purple-500 border-round"
              style="height: 3.5rem; width: 3.5rem"
            >
              <i class="text-50 pi pi-home text-2xl"></i>
            </span>
            <span class="ml-4 flex flex-column">
              <span class="text-900 lg:text-xl font-medium mb-0 block"
                >Перейти на главную страницу</span
              >
            </span>
          </router-link>
          <div
            class="w-full flex align-items-center py-5 border-300 border-bottom-1 cursor-pointer"
            @click="router.back()"
          >
            <span
              class="flex justify-content-center align-items-center bg-purple-500 border-round"
              style="height: 3.5rem; width: 3.5rem"
            >
              <i class="text-50 pi pi-arrow-left text-2xl"></i>
            </span>
            <span class="ml-4 flex flex-column">
              <span class="text-900 lg:text-xl font-medium mb-0 block"
