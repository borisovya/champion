  ...
  <div class="flex flex-column">
    ...
    <div v-if="!isLoading" class="flex flex-column justify-content-between">
      ...
      >
        ...
        <Column field="name" header="Название" style="width: min-content"></Column>
        <Column field="active" header="Статус" style="width: min-content">
          <template #body="slotProps">
            <Tag v-if="slotProps.data.active" severity="success" value="Активна"></Tag>
